...
const sortPeople = (arr) => {
  arr.sort((a,b) => {
    let A = a.lastName.toUpperCase();
    let B = b.lastName.toUpperCase();
    if (A<B){return -1;}
    else if (A>B){return 1;}
    else {return 0;}
  });
...
const sortPeopleBetter = (arr) => {
  arr.sort((a,b) => {
    let A = a.lastName.toUpperCase();
    let B = b.lastName.toUpperCase();
    let C = a.firstName.toUpperCase();
    let D = b.firstName.toUpperCase();
    let E = a.age;
    let F = b.age;
    if (A<B){return -1;}
    else if (A>B){return 1;}
...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((a,b) => dayToNumber[a.dayOfWeek] - dayToNumber[b.dayOfWeek])
};
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((a,b) => {
    return dayToNumber[a.dayOfWeek] - dayToNumber[b.dayOfWeek] || 
